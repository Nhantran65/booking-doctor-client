...
import com.bookingdoctor.backend.dao.AuthenticationDAO;
import com.bookingdoctor.backend.dao.AuthenticationResponse;
import com.bookingdoctor.backend.service.jwt.UserDetailsServiceImpl;
import com.bookingdoctor.backend.util.JwtUtil;
...
public class AuthenticationController {
    ...
    public AuthenticationResponse createAuthenticationToken(@RequestBody AuthenticationDAO authenticationDTO, HttpServletResponse response) throws BadCredentialsException, DisabledException, UsernameNotFoundException, IOException {
        try {
